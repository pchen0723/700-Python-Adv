...
class TestPlayCards(unittest.TestCase):
    ...
    def testWholeDeck(self):
        ...
        all_collapsed = functools.reduce(lambda x,y: x + y, all)
        all_collapsed.sort()
    ...
    def testTooMany(self):
        ...
        too_many_collapsed = functools.reduce(lambda x,y: x + y, too_many)
    ...
    def testWayTooMany(self):
        ...
        way_too_many_collapsed = functools.reduce(lambda x,y: x + y, way_too_many)
